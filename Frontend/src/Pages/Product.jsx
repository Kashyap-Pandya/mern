...
function Product() {
  ...
  return (
    <div className="w-[80vw] lg:w-fit mx-auto p-4">
      ...
      <div className="flex w-fit bg-slate-300 md:p-0 mx-auto rounded-lg shadow-lg flex-col items-start justify-around md:flex-row md:items-center">
        <div className="relative">
          <img
            src={url}
            alt={name}
            className="w-[20rem] min-h-auto object-fill rounded-b-none md:rounded-l-md"
          />
          <p
        ...
        <div className="p-4">
          ...
          <p className="text-gray-500 font-semibold text-xl font mt-2">
            {categoryName}
          </p>
          <p className="text-gray-500 font-semibold text-xl mt-2">
